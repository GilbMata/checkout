  ...
  useEffect(() => {
    ...
    const timer = setInterval(() => {
      setCountdown((prev) => {
        if (prev <= 1) {
          clearInterval(timer);
          window.location.href = "https://station24.com.mx/unete";
          return 0;
        }
        return prev - 1;
      });
        ...
        <div className="max-w-lg text-center">
          ...
          <div className="mt-12 flex items-center justify-center gap-4">
            ...
            <span className="text-gray-500 text-sm">
              Redireccionando en <span className="text-[#ff5b00] font-bold">{countdown}</span>s
            </span>
          ...
          {/* Skip link */}
          <button
            onClick={() => window.location.href = "https://station24.com.mx/unete"}
            className="mt-6 text-gray-500 text-sm hover:text-white transition-colors underline decoration-gray-700 hover:decoration-[#ff5b00]"
          >
            Ir ahora
          </button>
        </div>
