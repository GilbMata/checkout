  ...
  return (
    <Card className=" mx-auto border-none shadow-none bg-[#1e1e1e] p-5">
      ...
      <CardHeader className="text-center space-y-2">
        ...
        <div className="m-auto mt-1 inline-flex items-center gap-2 bg-linear-to-r from-orange-500/20 via-orange-400/20 to-orange-500/20 px-4 py-2 rounded-full border border-orange-500/30 shadow-[0_0_20px_rgba(249,115,22,0.2)]">
